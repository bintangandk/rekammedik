...
if ($result->num_rows == 0) {
    echo "
        ...
        <body>
            <div id='no-data'
                 data-message='Tidak ada data konsultasi pada rentang tanggal yang dipilih'>
            </div>
        </body>
        </html>
    ";
...
<table border='1' cellpadding='6' cellspacing='0' width='100%' style='border-collapse: collapse; font-size: 10pt;'>
    <thead>
